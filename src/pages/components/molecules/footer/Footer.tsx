                        ...
                        <div className="flex space-x-4">
                            {socialLinks.filter(social => social.url).map((social, index) => (
                                <a
                                    ...
                                    className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 hover:scale-110"
                        ...
                        <div className="space-y-3">
                            {personalInfo.social.email && (
                                <div className="flex items-center text-gray-300">
                                    ...
                                    <a href={personalInfo.social.email} className="hover:text-white transition-colors duration-300">
                                        {personalInfo.email}
                                    </a>
                                </div>
                            )}
                            ...
                            {personalInfo.social.github && (
                                <div className="flex items-center text-gray-300">
                                    ...
                                    <a href={personalInfo.social.github} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-300">
                                        GitHub
                                    </a>
                                </div>
                            )}
